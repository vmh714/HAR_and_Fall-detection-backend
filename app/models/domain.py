...
class Device(Base):
    ...
    telemetry_interval: Mapped[int] = mapped_column(Integer, default=30)  # chu kỳ gửi dữ liệu (giây)
    ...
    rssi_interval: Mapped[int] = mapped_column(Integer, default=0)  # chu kỳ đo RSSI 4G (giây); 0 = tắt
    org_id: Mapped[uuid.UUID] = mapped_column(ForeignKey("organizations.id"), nullable=False)
